        ...
        <div className="flex flex-col space-y-3 rounded-xl border p-6">
          ...
          <div>
            <DefaultText className="text-left font-inter text-base font-normal">
              Curates job openings and links from Twitter posts.
            </DefaultText>
          </div>
        </div>
        <div className="flex flex-col space-y-3 rounded-xl border p-6">
          ...
          <div>
            <DefaultText className="text-left font-inter text-base font-normal">
              Shares the latest job postings and daily job vacancies.
            </DefaultText>
          </div>
        </div>
        <div className="flex flex-col space-y-3 rounded-xl border p-6">
          ...
          <div>
            <DefaultText className="text-left font-inter text-base font-normal">
              Obtains the authors consent before retweeting and sharing content.
            </DefaultText>
          </div>
        </div>
        {/* Repeat the above three sections two more times */}
        {/* Add your additional sections here */}
        {/* Make sure to maintain the grid structure */}
      </div>
    </section>
  );
};
